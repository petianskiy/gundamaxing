...
function AppleStoreBadge({ href }: { href: string }) {
  return (
    <a
      ...
      className="inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-black border border-white/10 hover:border-white/25 hover:bg-zinc-900 transition-all duration-200 group"
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <ul className="mt-6 space-y-2">
              {["cards.app.feature1", "cards.app.feature2", "cards.app.feature3"].map((key) => (
          ...
          >
            {/* Portrait iPhone */}
            <div className="relative z-10 w-[160px] sm:w-[180px] drop-shadow-2xl">
              <Iphone />
            </div>

            {/* Landscape iPhone — rotated 90deg, shifted right + down */}
            <div
              className="absolute z-0 w-[160px] sm:w-[180px] drop-shadow-xl"
              style={{
            ...
            {/* Background glow */}
            <div className="absolute inset-0 bg-indigo-500/[0.05] rounded-full blur-[80px] pointer-events-none" />
          </motion.div>
