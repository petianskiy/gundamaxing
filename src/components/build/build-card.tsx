        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-3.5 z-[5]">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2 shrink-0 text-[11px] text-white/50">
                ...
                <span className="flex items-center gap-0.5"><Bookmark className="h-3 w-3" />{build.bookmarks}</span>
              </div>
            </div>
          </div>
        </motion.div>
